            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarResponsive">
                    <ul class="navbar-nav text-uppercase ml-auto">
                        ...
                        <li class="nav-item"><a class="nav-link js-scroll-trigger" href="#team">Artikel</a></li>
      ...
      <div class="row">
        <div class="col-md-12">
          @include('template.utils.notif')
                ...
                <a class="btn btn-primary btn-xl text-uppercase js-scroll-trigger" href="#team">Yuk baca</a>
            </div>
        </header>
        <!-- Team-->
                    ...
                    @foreach($list_artikel as $artikel)
                      <div class="col mb-4">
                        <div class="card h-100">
                          ...
                          <div class="card-body">
                            <h5 class="card-title" style="font-size: 12px">{{$artikel->judul}}</h5>
                            <small>Rilis : {{$artikel->tanggal}}</small>
                            <p class="card-text"> Penulis : {{$artikel->seller->nama}}</p>
                          </div>
                          <div class="card-footer">
                              <div class="text-center">
                                  <a href="{{url('baca', $artikel->id)}}" class="btn btn-info"><i class="fab fa-readme"></i></a>
                              </div>
                          </div>
                        </div>
                      </div>
